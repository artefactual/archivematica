...
type GolangciLintID = dagger.GolangciLintID
...
type GolangciLint = dagger.GolangciLint

type WithGolangciLintFunc = dagger.WithGolangciLintFunc

// GolangciLintRunOpts contains options for GolangciLint.Run
type GolangciLintRunOpts = dagger.GolangciLintRunOpts

// GolangciLintWithBuildCacheOpts contains options for GolangciLint.WithBuildCache
type GolangciLintWithBuildCacheOpts = dagger.GolangciLintWithBuildCacheOpts

// GolangciLintWithLinterCacheOpts contains options for GolangciLint.WithLinterCache
type GolangciLintWithLinterCacheOpts = dagger.GolangciLintWithLinterCacheOpts

// GolangciLintWithModuleCacheOpts contains options for GolangciLint.WithModuleCache
type GolangciLintWithModuleCacheOpts = dagger.GolangciLintWithModuleCacheOpts
...
type GolangciLintOpts = dagger.GolangciLintOpts
