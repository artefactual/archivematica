...
#Transcoder
$mysqldump CommandTypes CommandClassifications CommandsSupportedBy Commands FileIDTypes FileIDs CommandRelationships FileIDsByExtension FileIDsByFitsFileUtilityFormat FileIDsByFitsFfidentMimetype FileIDsByFitsDROIDIdentificationFile FileIDsByFitsJhoveFormat FileIDsByPronom Groups FileIDGroupMembers SubGroups DefaultCommandsForClassifications FilesIdentifiedIDs  $dumpTables >> $MCPDumpSQLLocation
$mysqldump CommandTypes CommandClassifications CommandsSupportedBy Commands FileIDTypes FileIDs CommandRelationships FileIDsByExtension FileIDsByFitsFileUtilityFormat FileIDsByFitsFfidentMimetype FileIDsByFitsDROIDIdentificationFile FileIDsByFitsJhoveFormat FileIDsByPronom Groups FileIDGroupMembers SubGroups DefaultCommandsForClassifications $dumpData >> $MCPDumpSQLLocation #Source of FPR DATA
