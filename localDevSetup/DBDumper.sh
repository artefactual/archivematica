...
dumpData="--skip-triggers --skip-comments --no-create-info --extended-insert=FALSE --complete-insert=TRUE"
...
#Transcoder
$mysqldump CommandTypes CommandClassifications CommandsSupportedBy Commands FileIDTypes FileIDs CommandRelationships FileIDsByExtension FileIDsByFitsFileUtilityFormat FileIDsByFitsFfidentMimetype FileIDsByFitsDROIDIdentificationPUID FileIDsByFitsJhoveFormat FileIDsByPronom FileIDsByFitsDROIDMimeType FileIDsByFitsFileUtilityMimetype FileIDsByFitsJhoveMimeType FileIDsByFitsFitsMimetype FileIDsByFitsFitsFormat Groups FileIDGroupMembers SubGroups DefaultCommandsForClassifications FilesIdentifiedIDs  $dumpTables >> $MCPDumpSQLLocation
$mysqldump CommandTypes CommandClassifications CommandsSupportedBy Commands FileIDTypes FileIDs CommandRelationships FileIDsByExtension FileIDsByFitsFileUtilityFormat FileIDsByFitsFfidentMimetype FileIDsByFitsDROIDIdentificationPUID FileIDsByFitsJhoveFormat FileIDsByPronom FileIDsByFitsDROIDMimeType FileIDsByFitsFileUtilityMimetype FileIDsByFitsJhoveMimeType FileIDsByFitsFitsMimetype FileIDsByFitsFitsFormat Groups FileIDGroupMembers SubGroups DefaultCommandsForClassifications $dumpData >> $MCPDumpSQLLocation #Source of FPR DATA
