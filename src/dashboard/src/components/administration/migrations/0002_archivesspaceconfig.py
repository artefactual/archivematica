...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AlterField(
            ...
            field=models.CharField(default='', max_length=50, verbose_name=b'Conditions governing access', blank=True),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='archiviststoolkitconfig',
            name='atuser',
            field=models.CharField(max_length=50, verbose_name=b'Archivists Toolkit Username'),
        ...
        migrations.AlterField(
            model_name='archiviststoolkitconfig',
            name='dbpass',
            field=models.CharField(max_length=50, verbose_name=b'Database Password', blank=True),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='archiviststoolkitconfig',
        ...
        migrations.AlterField(
            model_name='archiviststoolkitconfig',
            name='ead_actuate',
            field=models.CharField(default=b'none', max_length=50, verbose_name=b'EAD DAO Actuate', choices=[(b'none', b'None'), (b'onLoad', b'onLoad'), (b'other', b'other'), (b'onRequest', b'onRequest')]),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='archiviststoolkitconfig',
            name='ead_show',
            field=models.CharField(default=b'embed', max_length=50, verbose_name=b'EAD DAO Show', choices=[(b'embed', b'Embed'), (b'new', b'New'), (b'none', b'None'), (b'other', b'Other'), (b'replace', b'Replace')]),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='archiviststoolkitconfig',
        ...
        migrations.AlterField(
            model_name='archiviststoolkitconfig',
            name='object_type',
            field=models.CharField(default='', max_length=50, verbose_name=b'Object type', blank=True),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='archiviststoolkitconfig',
        ...
        migrations.AlterField(
            model_name='archiviststoolkitconfig',
            name='premis',
            field=models.CharField(default=b'yes', max_length=10, verbose_name=b'Restrictions Apply', choices=[(b'yes', b'Yes'), (b'no', b'No'), (b'premis', b'Base on PREMIS')]),
            preserve_default=True,
        ),
        migrations.AlterField(
            model_name='archiviststoolkitconfig',
        ...
        migrations.AlterField(
            model_name='archiviststoolkitconfig',
            name='use_conditions',
            field=models.CharField(default='', max_length=50, verbose_name=b'Conditions governing use', blank=True),
            preserve_default=False,
        ),
        migrations.AlterField(
            model_name='archiviststoolkitconfig',
