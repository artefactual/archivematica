...
def data_migration(apps, schema_editor):
    ...
    ArchivesSpaceConfig.objects.filter(id='5e6b9fb2-0ed0-41c4-b5cb-94d25de1a5dc').update(inherit_notes=False)


class Migration(migrations.Migration):

    dependencies = [
        ('administration', '0004_archivesspaceconfig_inherit_notes'),
    ]
