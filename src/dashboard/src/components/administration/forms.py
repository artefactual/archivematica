...
class ProcessingConfigurationForm(forms.Form):
    ...
    LABELS = {
        ...
        'f09847c2-ee51-429a-9478-a860477f6b8d': _('Perform file format identification (Transfer)'),
        ...
        '7a024896-c4f7-4808-a240-44c87c762bc5': _('Perform file format identification (Ingest)'),
        ...
        '087d27be-c719-47d8-9bbb-9a7d8b609c44': _('Perform file format identification (Submission documentation & metadata)'),
