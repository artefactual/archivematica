...
urlpatterns = [
    ...
    url(
        r"^(?P<uuid>" + settings.UUID_REGEX + ")/metadata/$", views.ingest_metadata_list
    ),
    url(
...
urlpatterns += [
    url(
        r"^(?P<uuid>"
        + settings.UUID_REGEX
        + ")/upload/atk/match/resource/(?P<resource_id>\d+)/$",
        views_atk.ingest_upload_atk_match_dip_objects_to_resource_levels,
    ),
    url(
        r"^(?P<uuid>"
        + settings.UUID_REGEX
        + ")/upload/atk/match/resourcecomponent/(?P<resource_component_id>\d+)/$",
        views_atk.ingest_upload_atk_match_dip_objects_to_resource_component_levels,
    ),
    url(
        r"^(?P<uuid>"
        + settings.UUID_REGEX
        + ")/upload/atk/resource/(?P<resource_id>\d+)/$",
        views_atk.ingest_upload_atk_resource,
    ),
    url(
        r"^(?P<uuid>"
        + settings.UUID_REGEX
        + ")/upload/atk/resourcecomponent/(?P<resource_component_id>\d+)/$",
        views_atk.ingest_upload_atk_resource_component,
    ),
    url(
        r"^(?P<uuid>" + settings.UUID_REGEX + ")/upload/atk/save/$",
        views_atk.ingest_upload_atk_save,
    ),
    url(
        r"^(?P<uuid>" + settings.UUID_REGEX + ")/upload/atk/reset/$",
        views_atk.ingest_upload_atk_reset,
    ),
    url(
        r"^(?P<uuid>" + settings.UUID_REGEX + ")/upload/atk/$",
        views_atk.ingest_upload_atk,
    ),
]
...
urlpatterns += [
    ...
    url(
        r"^(?P<uuid>" + settings.UUID_REGEX + ")/upload/as/$", views_as.ingest_upload_as
    ),
]
