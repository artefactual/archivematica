...
urlpatterns = patterns('',
    ...
    url(r'^unidentified_file_report/(?P<uuid>' + settings.UUID_REGEX + ')/$', views.unidentified_file_report),
    url(r'^get_unidentified_files/(?P<uuid>' + settings.UUID_REGEX + ')/$', views.get_unidentified_files),
    url(r'^get_unidentified_file_formats/(?P<uuid>' + settings.UUID_REGEX + ')/$', views.get_unidentified_file_formats),
