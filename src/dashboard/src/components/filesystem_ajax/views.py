...
def copy_to_arrange(request, sources=None, destinations=None, fetch_children=False):
    ...
    :param list sourcepath: List of paths relative to this pipelines backlog. If None, will look for filepath[] or filepath
    :param list destination: List of paths within arrange folder. All paths should start with DEFAULT_ARRANGE_PATH
    ...
    if sources[0].startswith('/' + DEFAULT_BACKLOG_PATH):
        ...
        logger.error('Filepath %s is not in base backlog path nor arrange path')
