...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table(u'fpr_fprule', (
            ...
            ('replaces', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fpr.FPRule'], to_field='uuid', null=True, blank=True)),
            ...
            ('purpose', self.gf('django.db.models.fields.CharField')(max_length=32)),
            ('command', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fpr.FPCommand'], to_field='uuid')),
            ('format', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fpr.FormatVersion'], to_field='uuid')),
            ('count_attempts', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('count_okay', self.gf('django.db.models.fields.IntegerField')(default=0)),
            ('count_not_okay', self.gf('django.db.models.fields.IntegerField')(default=0)),
        ))
        db.send_create_signal(u'fpr', ['FPRule'])

        # Adding model 'FPTool'
        db.create_table(u'fpr_fptool', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=36, blank=True)),
        ...
        db.create_table(u'fpr_formatversion', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('replaces', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fpr.FormatVersion'], to_field='uuid', null=True, blank=True)),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('lastmodified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=36, blank=True)),
            ('format', self.gf('django.db.models.fields.related.ForeignKey')(related_name='version_set', to_field='uuid', null=True, to=orm['fpr.Format'])),
            ('version', self.gf('django.db.models.fields.CharField')(max_length=10, null=True, blank=True)),
            ('pronom_id', self.gf('django.db.models.fields.CharField')(max_length=32, null=True, blank=True)),
        ...
        db.create_table(u'fpr_idrule', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('replaces', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fpr.IDRule'], to_field='uuid', null=True, blank=True)),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('lastmodified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=36, blank=True)),
        ...
        db.create_table(u'fpr_idcommand', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('replaces', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fpr.IDCommand'], to_field='uuid', null=True, blank=True)),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('lastmodified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=36, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ...
            ('tool', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fpr.IDTool'], to_field='uuid', null=True, blank=True)),
        ))
        ...
        db.create_table(u'fpr_format', (
            ...
            ('uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=36, blank=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=128)),
            ('group', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fpr.FormatGroup'], to_field='uuid', null=True)),
            ('slug', self.gf('autoslug.fields.AutoSlugField')(unique_with=(), max_length=50, populate_from='description')),
        ))
        db.send_create_signal(u'fpr', ['Format'])

        # Adding model 'FPCommand'
        db.create_table(u'fpr_fpcommand', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('replaces', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fpr.FPCommand'], to_field='uuid', null=True, blank=True)),
            ('enabled', self.gf('django.db.models.fields.BooleanField')(default=True)),
            ('lastmodified', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, blank=True)),
            ('uuid', self.gf('django.db.models.fields.CharField')(unique=True, max_length=36, blank=True)),
            ('tool', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fpr.FPTool'], to_field='uuid', null=True)),
            ('description', self.gf('django.db.models.fields.CharField')(max_length=256)),
            ...
            ('output_format', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fpr.FormatVersion'], to_field='uuid', null=True, blank=True)),
            ('command_usage', self.gf('django.db.models.fields.CharField')(max_length=16)),
            ('verification_command', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', to_field='uuid', null=True, to=orm['fpr.FPCommand'])),
            ('event_detail_command', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='+', to_field='uuid', null=True, to=orm['fpr.FPCommand'])),
        ))
        db.send_create_signal(u'fpr', ['FPCommand'])

        # Adding field 'FileID.format'
        db.add_column(u'FileID', 'format',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['fpr.FormatVersion'], to_field='uuid', null=True),
                      keep_default=False)


        # Changing field 'FileIDsBySingleID.replaces'
        db.alter_column(u'FileIDsBySingleID', 'replaces', self.gf('django.db.models.fields.CharField')(max_length=36, null=True, db_column='replaces'))

        # Changing field 'CommandClassification.replaces'
        db.alter_column(u'CommandClassification', 'replaces', self.gf('django.db.models.fields.CharField')(max_length=36, null=True, db_column='replaces'))

        # Changing field 'FileIDType.replaces'
        db.alter_column(u'FileIDType', 'replaces', self.gf('django.db.models.fields.CharField')(max_length=36, null=True, db_column='replaces'))

        # Changing field 'CommandType.replaces'
        db.alter_column(u'CommandType', 'replaces', self.gf('django.db.models.fields.CharField')(max_length=36, null=True, db_column='replaces'))
    ...
    def backwards(self, orm):
        ...
        # Changing field 'FileIDsBySingleID.replaces'
        db.alter_column(u'FileIDsBySingleID', 'replaces', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, db_column='replaces'))

        # Changing field 'CommandClassification.replaces'
        db.alter_column(u'CommandClassification', 'replaces', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, db_column='replaces'))

        # Changing field 'FileIDType.replaces'
        db.alter_column(u'FileIDType', 'replaces', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, db_column='replaces'))

        # Changing field 'CommandType.replaces'
        db.alter_column(u'CommandType', 'replaces', self.gf('django.db.models.fields.CharField')(max_length=50, null=True, db_column='replaces'))
    ...
    models = {
        ...
        u'fpr.format': {
            ...
            'group': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fpr.FormatGroup']", 'to_field': "'uuid'", 'null': 'True'}),
        ...
        u'fpr.formatversion': {
            ...
            'format': ('django.db.models.fields.related.ForeignKey', [], {'related_name': "'version_set'", 'to_field': "'uuid'", 'null': 'True', 'to': u"orm['fpr.Format']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'pronom_id': ('django.db.models.fields.CharField', [], {'max_length': '32', 'null': 'True', 'blank': 'True'}),
            'replaces': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fpr.FormatVersion']", 'to_field': "'uuid'", 'null': 'True', 'blank': 'True'}),
        ...
        u'fpr.fpcommand': {
            ...
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            'event_detail_command': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'to_field': "'uuid'", 'null': 'True', 'to': u"orm['fpr.FPCommand']"}),
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastmodified': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'output_format': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fpr.FormatVersion']", 'to_field': "'uuid'", 'null': 'True', 'blank': 'True'}),
            'output_location': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
            'replaces': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fpr.FPCommand']", 'to_field': "'uuid'", 'null': 'True', 'blank': 'True'}),
            'script_type': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            'tool': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fpr.FPTool']", 'to_field': "'uuid'", 'null': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '36', 'blank': 'True'}),
            'verification_command': ('django.db.models.fields.related.ForeignKey', [], {'blank': 'True', 'related_name': "'+'", 'to_field': "'uuid'", 'null': 'True', 'to': u"orm['fpr.FPCommand']"})
        },
        u'fpr.fprule': {
            'Meta': {'object_name': 'FPRule'},
            'command': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fpr.FPCommand']", 'to_field': "'uuid'"}),
            'count_attempts': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'count_not_okay': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'count_okay': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'enabled': ('django.db.models.fields.BooleanField', [], {'default': 'True'}),
            ...
            'replaces': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fpr.FPRule']", 'to_field': "'uuid'", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '36', 'blank': 'True'})
        },
        u'fpr.fptool': {
        ...
        u'fpr.idcommand': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastmodified': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'replaces': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fpr.IDCommand']", 'to_field': "'uuid'", 'null': 'True', 'blank': 'True'}),
            'script': ('django.db.models.fields.TextField', [], {}),
            'script_type': ('django.db.models.fields.CharField', [], {'max_length': '16'}),
            'tool': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fpr.IDTool']", 'to_field': "'uuid'", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '36', 'blank': 'True'})
        },
        u'fpr.idrule': {
            ...
            u'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'lastmodified': ('django.db.models.fields.DateTimeField', [], {'auto_now_add': 'True', 'blank': 'True'}),
            'replaces': ('django.db.models.fields.related.ForeignKey', [], {'to': u"orm['fpr.IDRule']", 'to_field': "'uuid'", 'null': 'True', 'blank': 'True'}),
            'uuid': ('django.db.models.fields.CharField', [], {'unique': 'True', 'max_length': '36', 'blank': 'True'})
        },
        u'fpr.idtool': {
