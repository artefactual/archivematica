...
app_name = "fpr"
urlpatterns = [
    re_path(r"^$", views.home, name="fpr_index"),
    re_path(
    ...
    # Formats
    re_path(r"^format/$", views.format_list, name="format_list"),
    re_path(r"^format/create/$", views.format_edit, name="format_create"),
    ...
    # Format groups
    re_path(r"^formatgroup/$", views.formatgroup_list, name="formatgroup_list"),
    re_path(
        r"^formatgroup/create/$", views.formatgroup_edit, name="formatgroup_create"
    ),
    re_path(
    ...
    # ID Tools
    re_path(r"^idtool/$", views.idtool_list, name="idtool_list"),
    re_path(r"^idtool/create/$", views.idtool_edit, name="idtool_create"),
    ...
    # ID Rules
    re_path(r"^idrule/$", views.idrule_list, name="idrule_list"),
    re_path(r"^idrule/create/$", views.idrule_edit, name="idrule_create"),
    re_path(
    ...
    # ID Commands
    re_path(r"^idcommand/$", views.idcommand_list, name="idcommand_list"),
    re_path(r"^idcommand/create/$", views.idcommand_edit, name="idcommand_create"),
    re_path(
    ...
    re_path(r"^fprule/create/$", views.fprule_edit, name="fprule_create"),
    re_path(r"^fprule/$", views.fprule_list, name="fprule_list"),
    ...
    # FP Tools
    re_path(r"^fptool/$", views.fptool_list, name="fptool_list"),
    re_path(r"^fptool/create/$", views.fptool_edit, name="fptool_create"),
    ...
    re_path(r"^fpcommand/create/$", views.fpcommand_edit, name="fpcommand_create"),
    re_path(
        r"^fpcommand/(?P<usage>[-\w]+)/$", views.fpcommand_list, name="fpcommand_list"
    ),
    re_path(r"^fpcommand/$", views.fpcommand_list, name="fpcommand_list"),
    re_path(
