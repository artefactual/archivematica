...
def data_migration_up(apps, schema_editor):
    ...
    old_fido_command = idcommand.objects\
        .get(uuid='6fa7b8d8-10f1-439d-888a-5ccb3a5be492')

    idcommand.objects.create(
        uuid='e586f750-6230-42d7-8d12-1e24ca2aa658',
        description=u'Identify using Fido 1.3.10',
...
def data_migration_down(apps, schema_editor):
    ...
    idcommand.objects\
        .filter(uuid='e586f750-6230-42d7-8d12-1e24ca2aa658').delete()
    ...
    idcommand.objects\
        .filter(uuid='6fa7b8d8-10f1-439d-888a-5ccb3a5be492')\
        .update(enabled=True)
