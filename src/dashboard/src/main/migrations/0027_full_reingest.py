...
def data_migration(apps, schema_editor):
    ...
    StandardTaskConfig.objects.create(id='3362ef11-b4f1-4862-b91d-496665d15cce', requires_output_lock=0, execute='failedTransferCleanup', arguments='"fail" "%SIPUUID%" "%SIPDirectory%"')
    TaskConfig.objects.create(id='6b2a7301-df99-4157-b09f-76e87e08f6d9', tasktype_id='36b2e239-4a57-4aa5-8ebc-7a29139baca6', tasktypepkreference='3362ef11-b4f1-4862-b91d-496665d15cce', description='Cleanup failed Transfer')
    MicroServiceChainLink.objects.create(id='e780473a-0c10-431f-bab6-5d7238b2b70b', microservicegroup='Failed transfer', defaultexitmessage='Failed', currenttask_id='6b2a7301-df99-4157-b09f-76e87e08f6d9', defaultnextchainlink_id='377f8ebb-7989-4a68-9361-658079ff8138')
    MicroServiceChainLinkExitCode.objects.create(id='f4abbac5-558b-4c2b-8f4f-cdf13cf57249', microservicechainlink_id='e780473a-0c10-431f-bab6-5d7238b2b70b', exitcode=0, nextmicroservicechainlink_id='377f8ebb-7989-4a68-9361-658079ff8138', exitmessage='Completed successfully')
    MicroServiceChainLinkExitCode.objects.filter(microservicechainlink_id='61c316a6-0a50-4f65-8767-1f44b1eeb6dd').update(nextmicroservicechainlink_id='e780473a-0c10-431f-bab6-5d7238b2b70b')

    # Add failedTransferCleanup script to rejected
    StandardTaskConfig.objects.create(id='72f11e68-7350-42a7-9bdc-60001d0505a2', requires_output_lock=0, execute='failedTransferCleanup', arguments='"reject" "%SIPUUID%" "%SIPDirectory%"')
    TaskConfig.objects.create(id='1fea5138-981f-4fef-9d74-4d6328fb9248', tasktype_id='36b2e239-4a57-4aa5-8ebc-7a29139baca6', tasktypepkreference='72f11e68-7350-42a7-9bdc-60001d0505a2', description='Cleanup rejected transfer')
