...
def data_migration(apps, schema_editor):
    ...
    msclec_bridge = {'f0f64c7e-30fa-47c1-9877-43955680c0d0':'88a36d00-af47-4845-8bcf-a72529ae78f8',
                     'cb48ef2a-3394-4936-af1f-557b39620efa':'800259c7-f6d2-4ac6-af69-07985f23efec',
                     '5e4bd4e8-d158-4c2a-be89-51e3e9bd4a06':'1462359e-72c8-467f-b08a-02e4e3dfede1',
                     '10c40e41-fb10-48b5-9d01-336cd958afe8':'e090fea3-2e44-4dd9-b17d-73c4d2088e0c',
                     '7c6a0b72-f37b-4512-87f3-267644de6f80':'8bec6c39-8b98-4e2c-9a91-f7a9c8130f2e',
                     '11033dbd-e4d4-4dd6-8bcf-48c424e222e3':'18db3a8a-ee5f-47c2-b5a7-7d223c3023c0',
                     'b21018df-f67d-469a-9ceb-ac92ac68654e':'4de0e894-8eda-49eb-a915-124b4f6c3608',
                     '8c8bac29-4102-4fd2-9d0a-a3bd2e607566': '5e481248-543b-463d-b0a4-eee87c79e71f'}

    for key in msclec_bridge:
        MicroServiceChainLinkExitCode.objects.filter(pk=msclec_bridge[key]).update(nextmicroservicechainlink_id=key)
    ...
    MicroServiceChainLinkExitCode.objects.filter(pk__in=msclecs_delete).delete()
    ...
    MicroServiceChainLink.objects.filter(pk__in=mscls_delete).delete()

    # Delete all TaskConfigs corresponding to updateSizeAndChecksum
    tcs_delete = ['6405c283-9eed-410d-92b1-ce7d938ef080', '1c7de28f-8f18-41c7-b03a-19f900d38f34',
                   ...
                   'bd9769ba-4182-4dd4-ba85-cff24ea8733e']
    TaskConfig.objects.filter(pk__in=tcs_delete).delete()
    ...
    StandardTaskConfig.objects.filter(pk__in=stcs_delete).delete()
