...
def data_migration(apps, schema_editor):
    ...
    #upload_as_cl.currenttask.tasktypepkreference = None
    ...
    continue_dip_upload_choice_tc = TaskConfig.objects.create(
        ...
        # This should not be None. This needs to be ...
    ...
    continue_dip_upload_check_choice_cl = MicroServiceChainLink.objects.create(
        ...
        # defaultnextchainlink=upload_as_cl,
    ...
    #     id='af5714aa-e463-47c2-b30f-16b075a7c28f',
    #     microservicechainlink=continue_dip_upload_check_choice_cl,
    #     exitcode=0,
    #     exitmessage=2,
    #     nextmicroservicechainlink=upload_as_cl
    # )
