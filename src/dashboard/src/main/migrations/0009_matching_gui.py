...
def data_migration(apps, schema_editor):
    ...
    StandardTaskConfig.objects.create(pk='cbe200ab-a634-4902-a0e6-8ed1858538d4', requires_output_lock=False, execute='dipGenerationHelper', arguments='--sipUUID "%SIPUUID%" --sipPath "%SIPDirectory%"')
    TaskConfig.objects.create(pk='5e0ac12e-6ce7-4d11-bd75-e14167210df4', tasktype_id='36b2e239-4a57-4aa5-8ebc-7a29139baca6', tasktypepkreference='cbe200ab-a634-4902-a0e6-8ed1858538d4', description='Pre-processing for DIP generation')
