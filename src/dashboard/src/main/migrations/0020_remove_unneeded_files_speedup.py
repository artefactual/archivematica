...
def data_migration(apps, schema_editor):
    ...
    StandardTaskConfig.objects.filter(pk='49b803e3-8342-4098-bb3f-434e1eb5cfa8').update(arguments='"%SIPObjectsDirectory%" "%SIPUUID%"')
    StandardTaskConfig.objects.filter(pk='49b803e3-8342-4098-bb3f-434e1eb5cfa8').update(lastmodified=date_modified)
    StandardTaskConfig.objects.filter(pk='66aa823d-3b72-4d13-9ad6-c5e6580857b8').update(arguments='"%SIPObjectsDirectory%" "%SIPUUID%"')
