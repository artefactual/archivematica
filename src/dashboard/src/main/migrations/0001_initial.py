    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('identifiertype', models.TextField(null=True, verbose_name=b'Agent Identifier Type', db_column=b'agentIdentifierType')),
                ('identifiervalue', models.TextField(help_text=b'Used for premis:agentIdentifierValue and premis:linkingAgentIdentifierValue in the METS file.', null=True, verbose_name=b'Agent Identifier Value', db_column=b'agentIdentifierValue')),
                ('name', models.TextField(help_text=b'Used for premis:agentName in the METS file.', null=True, verbose_name=b'Agent Name', db_column=b'agentName')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('lastmodified', models.DateTimeField(db_column=b'lastModified')),
                ('replaces', models.ForeignKey(related_name='replaced_by', db_column=b'replaces', to='main.MicroServiceChain', null=True, blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('rightsbasis', models.CharField(default=b'Copyright', max_length=64, verbose_name=b'Basis', db_column=b'rightsBasis', choices=[(b'Copyright', b'Copyright'), (b'Statute', b'Statute'), (b'License', b'License'), (b'Donor', b'Donor'), (b'Policy', b'Policy'), (b'Other', b'Other')])),
                ('status', models.CharField(default=b'ORIGINAL', max_length=8, db_column=b'status', choices=[(b'ORIGINAL', b'original'), (b'REINGEST', b'parsed from reingest'), (b'UPDATED', b'updated')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, editable=False, primary_key=True, db_column=b'pk')),
                ('copyrightstatus', models.TextField(verbose_name=b'Copyright status', db_column=b'copyrightStatus')),
                ('copyrightjurisdiction', models.TextField(verbose_name=b'Copyright jurisdiction', db_column=b'copyrightJurisdiction')),
                ('copyrightstatusdeterminationdate', models.TextField(help_text=b'Use ISO 8061 (YYYY-MM-DD)', null=True, verbose_name=b'Copyright determination date', db_column=b'copyrightStatusDeterminationDate', blank=True)),
                ('copyrightapplicablestartdate', models.TextField(help_text=b'Use ISO 8061 (YYYY-MM-DD)', null=True, verbose_name=b'Copyright start date', db_column=b'copyrightApplicableStartDate', blank=True)),
                ('copyrightapplicableenddate', models.TextField(help_text=b'Use ISO 8061 (YYYY-MM-DD)', null=True, verbose_name=b'Copyright end date', db_column=b'copyrightApplicableEndDate', blank=True)),
                ('copyrightenddateopen', models.BooleanField(default=False, help_text=b'Indicate end date is open', verbose_name=b'Open End Date', db_column=b'copyrightApplicableEndDateOpen')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, editable=False, primary_key=True, db_column=b'pk')),
                ('copyrightdocumentationidentifiertype', models.TextField(verbose_name=b'Copyright document identification type', db_column=b'copyrightDocumentationIdentifierType')),
                ('copyrightdocumentationidentifiervalue', models.TextField(verbose_name=b'Copyright document identification value', db_column=b'copyrightDocumentationIdentifierValue')),
                ('copyrightdocumentationidentifierrole', models.TextField(null=True, verbose_name=b'Copyright document identification role', db_column=b'copyrightDocumentationIdentifierRole', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, editable=False, primary_key=True, db_column=b'pk')),
                ('copyrightnote', models.TextField(verbose_name=b'Copyright note', db_column=b'copyrightNote')),
                ('rightscopyright', models.ForeignKey(to='main.RightsStatementCopyright', db_column=b'fkRightsStatementCopyrightInformation')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, editable=False, primary_key=True, db_column=b'pk')),
                ('licenseterms', models.TextField(null=True, verbose_name=b'License terms', db_column=b'licenseTerms', blank=True)),
                ('licenseapplicablestartdate', models.TextField(help_text=b'Use ISO 8061 (YYYY-MM-DD)', null=True, verbose_name=b'License start date', db_column=b'licenseApplicableStartDate', blank=True)),
                ('licenseapplicableenddate', models.TextField(help_text=b'Use ISO 8061 (YYYY-MM-DD)', null=True, verbose_name=b'License end date', db_column=b'licenseApplicableEndDate', blank=True)),
                ('licenseenddateopen', models.BooleanField(default=False, help_text=b'Indicate end date is open', verbose_name=b'Open End Date', db_column=b'licenseApplicableEndDateOpen')),
                ('rightsstatement', models.ForeignKey(to='main.RightsStatement', db_column=b'fkRightsStatement')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, editable=False, primary_key=True, db_column=b'pk')),
                ('licensedocumentationidentifiertype', models.TextField(verbose_name=b'License documentation identification type', db_column=b'licenseDocumentationIdentifierType')),
                ('licensedocumentationidentifiervalue', models.TextField(verbose_name=b'License documentation identification value', db_column=b'licenseDocumentationIdentifierValue')),
                ('licensedocumentationidentifierrole', models.TextField(null=True, verbose_name=b'License document identification role', db_column=b'licenseDocumentationIdentifierRole', blank=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, editable=False, primary_key=True, db_column=b'pk')),
                ('licensenote', models.TextField(verbose_name=b'License note', db_column=b'licenseNote')),
                ('rightsstatementlicense', models.ForeignKey(to='main.RightsStatementLicense', db_column=b'fkRightsStatementLicense')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, editable=False, primary_key=True, db_column=b'pk')),
                ('otherrightsdocumentationidentifiertype', models.TextField(verbose_name=b'Other rights document identification type', db_column=b'otherRightsDocumentationIdentifierType')),
                ('otherrightsdocumentationidentifiervalue', models.TextField(verbose_name=b'Other right document identification value', db_column=b'otherRightsDocumentationIdentifierValue')),
                ('otherrightsdocumentationidentifierrole', models.TextField(null=True, verbose_name=b'Other rights document identification role', db_column=b'otherRightsDocumentationIdentifierRole', blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, editable=False, primary_key=True, db_column=b'pk')),
                ('otherrightsbasis', models.TextField(default=b'Other', verbose_name=b'Other rights basis', db_column=b'otherRightsBasis')),
                ('otherrightsapplicablestartdate', models.TextField(help_text=b'Use ISO 8061 (YYYY-MM-DD)', null=True, verbose_name=b'Other rights start date', db_column=b'otherRightsApplicableStartDate', blank=True)),
                ('otherrightsapplicableenddate', models.TextField(help_text=b'Use ISO 8061 (YYYY-MM-DD)', null=True, verbose_name=b'Other rights end date', db_column=b'otherRightsApplicableEndDate', blank=True)),
                ('otherrightsenddateopen', models.BooleanField(default=False, help_text=b'Indicate end date is open', verbose_name=b'Open End Date', db_column=b'otherRightsApplicableEndDateOpen')),
                ('rightsstatement', models.ForeignKey(to='main.RightsStatement', db_column=b'fkRightsStatement')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, primary_key=True, db_column=b'pk')),
                ('otherrightsnote', models.TextField(verbose_name=b'Other rights note', db_column=b'otherRightsNote')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('startdate', models.TextField(help_text=b'Use ISO 8061 (YYYY-MM-DD)', null=True, verbose_name=b'Start', db_column=b'startDate', blank=True)),
                ('enddate', models.TextField(help_text=b'Use ISO 8061 (YYYY-MM-DD)', null=True, verbose_name=b'End', db_column=b'endDate', blank=True)),
                ('enddateopen', models.BooleanField(default=False, help_text=b'Indicate end date is open', verbose_name=b'Open End Date', db_column=b'endDateOpen')),
                ('rightsstatement', models.ForeignKey(to='main.RightsStatement', db_column=b'fkRightsStatement')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, editable=False, primary_key=True, db_column=b'pk')),
                ('rightsgrantednote', models.TextField(verbose_name=b'Rights note', db_column=b'rightsGrantedNote')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, editable=False, primary_key=True, db_column=b'pk')),
                ('statutedocumentationidentifiertype', models.TextField(verbose_name=b'Statute document identification type', db_column=b'statuteDocumentationIdentifierType')),
                ('statutedocumentationidentifiervalue', models.TextField(verbose_name=b'Statute document identification value', db_column=b'statuteDocumentationIdentifierValue')),
                ('statutedocumentationidentifierrole', models.TextField(null=True, verbose_name=b'Statute document identification role', db_column=b'statuteDocumentationIdentifierRole', blank=True)),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, primary_key=True, db_column=b'pk')),
                ('statutejurisdiction', models.TextField(verbose_name=b'Statute jurisdiction', db_column=b'statuteJurisdiction')),
                ('statutecitation', models.TextField(verbose_name=b'Statute citation', db_column=b'statuteCitation')),
                ('statutedeterminationdate', models.TextField(help_text=b'Use ISO 8061 (YYYY-MM-DD)', null=True, verbose_name=b'Statute determination date', db_column=b'statuteInformationDeterminationDate', blank=True)),
                ('statuteapplicablestartdate', models.TextField(help_text=b'Use ISO 8061 (YYYY-MM-DD)', null=True, verbose_name=b'Statute start date', db_column=b'statuteApplicableStartDate', blank=True)),
                ('statuteapplicableenddate', models.TextField(help_text=b'Use ISO 8061 (YYYY-MM-DD)', null=True, verbose_name=b'Statute end date', db_column=b'statuteApplicableEndDate', blank=True)),
                ('statuteenddateopen', models.BooleanField(default=False, help_text=b'Indicate end date is open', verbose_name=b'Open End Date', db_column=b'statuteApplicableEndDateOpen')),
                ('rightsstatement', models.ForeignKey(to='main.RightsStatement', db_column=b'fkRightsStatement')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(serialize=False, primary_key=True, db_column=b'pk')),
                ('statutenote', models.TextField(verbose_name=b'Statute note', db_column=b'statuteNote')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('sip_type', models.CharField(default=b'SIP', max_length=8, db_column=b'sipType', choices=[(b'SIP', b'SIP'), (b'AIC', b'AIC'), (b'AIP-REIN', b'Reingested AIP'), (b'AIC-REIN', b'Reingested AIC')])),
