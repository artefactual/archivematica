...
-- Remove old version of indexing transfer contents
SET @d1='eb52299b-9ae6-4a1f-831e-c7eee0de829f' COLLATE utf8_unicode_ci;
SET @d2='aa2e26b3-539e-4071-b54c-bcb89650d2d2' COLLATE utf8_unicode_ci;
DELETE FROM MicroServiceChainLinks WHERE pk=@d1;
DELETE FROM TasksConfigs WHERE pk=@d2;
