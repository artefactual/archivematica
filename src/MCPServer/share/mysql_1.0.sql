...
CREATE TABLE `TasksConfigsStartLinkForEachFile` (
  ...
  `lastModified` timestamp NOT NULL DEFAULT CURRENT_TIMESTAMP,
  PRIMARY KEY (`pk`),
  KEY `TasksConfigsStartLinkForEachFile` (`pk`),
  KEY `execute` (`execute`),
  CONSTRAINT `TasksConfigsStartLinkForEachFile_ibfk_1` FOREIGN KEY (`execute`) REFERENCES `MicroServiceChains` (`pk`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8 COLLATE=utf8_unicode_ci;
/*!40101 SET character_set_client = @saved_cs_client */;

--
-- Dumping data for table `TasksConfigsStartLinkForEachFile`
--

LOCK TABLES `TasksConfigsStartLinkForEachFile` WRITE;
/*!40000 ALTER TABLE `TasksConfigsStartLinkForEachFile` DISABLE KEYS */;
INSERT INTO `TasksConfigsStartLinkForEachFile` VALUES ('1dfb37b4-af59-4754-a62a-ee0dd3131d7d','objects','3c7124dc-5b28-44d6-8f6e-ddc7cde1fe66',NULL,'2012-10-02 00:25:04'),('391f8f14-82e8-48a3-8881-51cc59d8004f','objects','9c9e52c0-ec0e-486e-b826-a62559c16d23',NULL,'2012-10-02 00:25:04'),('43c0f6a1-4e4b-41e3-b7b8-0457e929d6f0','objects','d9278c18-8d34-4d76-a95c-ce948f45a5f2',NULL,'2012-10-02 00:25:04'),('6909b431-dcb8-4bbe-ba07-2cf5001f4dc8','objects/submissionDocumentation','9c4d2ba4-9b10-4345-a05f-a2298092f87f',NULL,'2012-10-02 00:25:04'),('77cb3b6d-1016-47a2-a927-22012445572e','objects','0b55e0f6-6fea-4cdc-8016-13300ccef4f7',NULL,'2012-10-02 00:25:04'),('ae0b5497-0820-41d3-ac87-15f33fa22ad5','objects','9c9e52c0-ec0e-486e-b826-a62559c16d23',NULL,'2012-10-02 00:25:04'),('bfbdf2a8-ba58-4768-a594-335f4e27c9d5','objects','d9278c18-8d34-4d76-a95c-ce948f45a5f2',NULL,'2012-10-02 00:25:04'),('d7fab314-1169-44ab-8146-723b42ff36b1','objects/submissionDocumentation','04ccb636-17bf-41ed-bee0-574fa2417453',NULL,'2012-10-02 00:25:04'),('ee258233-0123-42bf-a200-0e2ff7a6676b','objects/service','3f798b85-2652-4718-b32e-30dc13ec0da8',NULL,'2012-10-02 00:25:04');
/*!40000 ALTER TABLE `TasksConfigsStartLinkForEachFile` ENABLE KEYS */;
UNLOCK TABLES;
...
-- Dump completed on 2013-11-07 16:07:04
