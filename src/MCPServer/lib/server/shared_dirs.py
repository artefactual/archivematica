...
AUTOMATED_PROCESSING_CONFIG = """<processingMCP>
  <preconfiguredChoices>
    ...
    <!-- Do you want to perform file format identification?: Yes -->
    <preconfiguredChoice>
