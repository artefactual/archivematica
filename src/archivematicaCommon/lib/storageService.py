...
def get_setting_no_orm(setting, default=None):
...
def _storage_api():
    ...
    storage_service_url = get_setting_no_orm('storage_service_url')
...
def request_file_deletion(uuid, user_id, user_email, reason_for_deletion):
    ...
    api_request = {
        ...
        'pipeline':     get_setting_no_orm('dashboard_uuid', default=''),
