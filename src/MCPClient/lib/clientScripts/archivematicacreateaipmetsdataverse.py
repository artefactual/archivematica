...
logger = get_script_logger("archivematica.mcp.client.dataverseaip")
...
def write_dv_mets(sip_type="SIP",
                  baseDirectoryPath="",
                  baseDirectoryPathString="SIPDirectory",
                  fileGroupIdentifier="",
                  fileGroupType="sipUUID",
                  xmlFile="",
                  amdSec=False):
    ...
    includeAmdSec = amdSec

    logger.error("Entering Dataverse specific METS2")
