...
#
# first version of this script gets the input from arguments, next version will get it from MCP db.
#
...
def get_user_input(job):
    job.pyprint("Archivematica import to AT script")
    job.pyprint("Welcome\n")
